<%-- 
    Document   : employee
    Created on : Oct 10, 2019, 3:21:20 PM
    Author     : leehe
--%>
...
<html lang="en-US" class="">
    <head>
        ...
        <meta property="og:url" content="http://www.simplesite.com/us-123health/118896512">
        <meta property="og:title" content="Charlotte Robert">
        <meta property="og:description" content="
              Masseur and sports masseur
              (Medical and physiotherapist examined)
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
              diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobort...">
        <meta property="og:image" content="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314494044460._szw1280h1280_.jpg">
        <meta property="og:updated_time" content="2016-06-18T11:23:22.8695455+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Employees - www.simplesite.com_us-123health_files/8472132.design.v26182.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123health/118896512">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./Employees - www.simplesite.com_us-123health_files/analytics.js"></script><script async="" src="./Employees - www.simplesite.com_us-123health_files/gtm.js"></script><script type="text/javascript" src="./Employees - www.simplesite.com_us-123health_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Employees - www.simplesite.com_us-123health_files/frontendApp.min.js"></script>
    ...
    <body data-pid="118896512" data-iid="">
                            ...
                            <div class="container">
                                ...
                                <div class="nav-collapse collapse">
                                    <ul class="nav" id="topMenu" data-submenu="horizontal">
                                        <li class="  " style="">
                                            <a rel="nofollow" href="DispatchServlet?btnAction=Home">Welcome</a>
                                        </li><li class="  " style="">
                                            <a rel="nofollow" href="DispatchServlet?btnAction=Service">Therapy and Massage</a>
                                        </li><li class="  " style="">
                                            <a rel="nofollow" href="DispatchServlet?btnAction=Price">Price List</a>
                                        </li><li class=" active " style="">
                                            <a rel="nofollow" href="DispatchServlet?btnAction=Employee">Employees</a>
                                        </li><li class="  " style="">
                                            <a rel="nofollow" href="DispatchServlet?btnAction=Contact">Contact us</a>
                                        </li>                </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper ">
                                <div class="content">
                                    <c:forEach var="dto" items="${requestScope.EMP}">
                                        <div class="section article">
                                            ...
                                            <div class="content">
                                                <div class="img-simple span3 pull-left">
                                                    <div class="image">
                                                        <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314494044460._szw1280h1280_.jpg"><img src="${dto.img}"></a>
                                                    </div>
                                                </div>
                                                <p><span style="font-size: 16px;">${dto.job}<strong><br></strong></span></p> <p><span style="font-size: 16px;" data-mce-mark="1">${dto.intro}</span></p>    </div>
                                        </div>
                                    </c:forEach>
                                </div>
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content"><span><ul>
                                                <li><a id="share-facebook" href="http://www.simplesite.com/us-123health/118896512#"><i class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
                                                <li><a id="share-twitter" href="http://www.simplesite.com/us-123health/118896512#"><i class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
                                                <li><a id="share-google-plus" href="http://www.simplesite.com/us-123health/118896512#"><i class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>    
                                            </ul></span></div>
                                </div>
                            </div>
                        </div>
