<%-- 
    Document   : service
    Created on : Oct 10, 2019, 9:57:44 PM
    Author     : leehe
--%>
...
<!DOCTYPE html>
<!-- saved from url=(0048)http://www.simplesite.com/us-123health/118896508 -->
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Therapy and Massage</title>
        ...
        <meta property="og:url" content="http://www.simplesite.com/us-123health/118896508">
        <meta property="og:title" content="The Balance &amp; Harmony of Body and Mind">
        <meta property="og:description" content="
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip
              ex ea commodo consequat. Duis autem vel eum iriur...">
        <meta property="og:image" content="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314541983971._szw1280h1280_.jpg">
        <meta property="og:updated_time" content="2016-06-18T11:23:13.8523987+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Therapy and Massage - www.simplesite.com_us-123health_files/8472132.design.v26182.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123health/118896508">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./Therapy and Massage - www.simplesite.com_us-123health_files/analytics.js"></script><script async="" src="./Therapy and Massage - www.simplesite.com_us-123health_files/gtm.js"></script><script type="text/javascript" src="./Therapy and Massage - www.simplesite.com_us-123health_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Therapy and Massage - www.simplesite.com_us-123health_files/frontendApp.min.js"></script>
    ...
    <body data-pid="118896508" data-iid="">
                ...
                <div class="container">
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper ">
                                <div class="content">
                                    <c:forEach var="dto" items="${requestScope.SERVICE}" varStatus="counter">
                                        <div class="section article">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="img-simple span6 pull-left">
                                                    <div class="image">
                                                        <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314541983971._szw1280h1280_.jpg"><img src="${dto.img}"></a>
                                                    </div>
                                                </div>
                                                <p><span>${dto.intro}</span></p>   
                                                </c:if>
                                                <c:if test="${counter.count % 2 != 0}">
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content"><span><ul>
                                                <li><a id="share-facebook" href="http://www.simplesite.com/us-123health/118896508#"><i class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
                                                <li><a id="share-twitter" href="http://www.simplesite.com/us-123health/118896508#"><i class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
                                                <li><a id="share-google-plus" href="http://www.simplesite.com/us-123health/118896508#"><i class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>    
                                            </ul></span></div>
                                </div>
                            </div>
                        </div>
