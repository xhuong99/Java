<%-- 
    Document   : price
    Created on : Oct 16, 2019, 8:26:59 AM
    Author     : leehe
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:updated_time" content="2016-06-18T11:23:18.8757919+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Price List - www.simplesite.com_us-123health_files/8472132.design.v26182.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123health/118896511">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./Price List - www.simplesite.com_us-123health_files/analytics.js"></script><script async="" src="./Price List - www.simplesite.com_us-123health_files/gtm.js"></script><script type="text/javascript" src="./Price List - www.simplesite.com_us-123health_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Price List - www.simplesite.com_us-123health_files/frontendApp.min.js"></script>
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <c:forEach var="treatment" items="${requestScope.SERV}">
                                                        <tr>
                                                            <td>${treatment.treatment}</td>
                                                            <td>${treatment.info}</td>
                                                            <td class="align-right">€${treatment.price}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
                                                ...
                                                <tbody>
                                                    <c:forEach var="course" items="${requestScope.COURSE}">
                                                        <tr>
                                                            <td>${course.title}</td>
                                                            <td>${course.info}</td>
                                                            <td class="align-right">€${course.price}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
