<%-- 
    Document   : index
    Created on : Oct 9, 2019, 11:08:10 AM
    Author     : leehe
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:updated_time" content="2016-06-18T11:22:56.4733303+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Welcome - www.simplesite.com_us-123health_files/8472132.design.v26182.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123health/">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <link rel="stylesheet" type="text/css" href="./Welcome - www.simplesite.com_us-123health_files/css">
        <script type="text/javascript" async="" src="./Welcome - www.simplesite.com_us-123health_files/analytics.js"></script><script async="" src="./Welcome - www.simplesite.com_us-123health_files/gtm.js"></script><script type="text/javascript" src="./Welcome - www.simplesite.com_us-123health_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Welcome - www.simplesite.com_us-123health_files/frontendApp.min.js"></script>
                            ...
                            <div class="wrapper ">
                                <div class="content">
                                    <div class="section article">
                                        <div class="content">
                                            <div class="img-simple span12 ">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314524568867._szw1280h1280_.jpg"><img src="${requestScope.IMG[0].img}"></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <ul class="thumbnails column-article-section">
                                                <c:forEach var="intro" items="${requestScope.INTRO}">
                                                    <li class="span4">
                                                        <div class="img-simple span12 ">
                                                            <div class="image">
                                                                <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314491420783._szw1280h1280_.jpg"><img src="${intro.img}"></a>
                                                            </div>
                                                        </div>

                                                        <h4>
                                                            <a rel="nofollow" href="DispatchServlet?btnAction=Service">${intro.title}</a>
                                                        </h4>
                                        ...
                                        <div class="content">
                                            <dl class="dl-horizontal">
                                                <c:forEach var="course" items="${requestScope.COURSE}">
                                                    <dt><span class="date-text">${course.date}</span></dt>
                                                    <dd>
                                                        <h4>${course.title}</h4>
                                    ...
                                    <div class="section article">
                                        ...
                                        <div class="content">
                                            <p>Tel: ${emp.phone}</p> <p><span data-mce-mark="1">Email: ${emp.email}</span></p> <p>We are committed to your well-being. If you have any comments, questions or concerns feel free to contact us</p>    </div>
                                    </div>
                                    <div class="section signature">
                                        <div class="content">
                                            <div class="img-simple span4 signature-image">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314527777596._szw1280h1280_.jpg"><img src="${emp.img}"></a>
                                                </div>
                                            </div>
