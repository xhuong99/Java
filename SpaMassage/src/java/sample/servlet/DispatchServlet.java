...
public class DispatchServlet extends HttpServlet {
    ...
    public static final String CONTACT_SERVLET = "ContactServlet";
    public static final String EMPLOYEE_SERVLET = "EmployeeServlet";
    public static final String PRICE_SERVLET = "PriceServlet";
    public static final String SERVICE_SERVLET = "ServiceServlet";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (button == null) {
                ...
                url = CONTACT_SERVLET;
            } else if (button.equals("Employee")) {
                url = EMPLOYEE_SERVLET;
            } else if (button.equals("Price")) {
                url = PRICE_SERVLET;
            } else if (button.equals("Service")) {
                url = SERVICE_SERVLET;
            }
        } finally {
